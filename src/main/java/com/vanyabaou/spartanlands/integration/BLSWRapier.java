...
public class BLSWRapier extends ItemRapier implements ICorrodible, IAnimatorRepairable {
    ...
    public BLSWRapier(String unlocName, ToolMaterialEx material) {
    ...
    public Multimap<String, AttributeModifier> getAttributeModifiers(EntityEquipmentSlot slot, ItemStack stack) {
        return CorrosionHelper.getAttributeModifiers(super.getAttributeModifiers(slot, stack), slot, stack, ItemTool.ATTACK_DAMAGE_MODIFIER, Math.max(0.5F, this.toolMaterial.getAttackDamage() * ConfigHandler.damageMultiplierRapier + ConfigHandler.damageBaseRapier - 1f));
    }
